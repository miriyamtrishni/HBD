...
export default function Cake() {
  ...
  function playMelody(tempoBPM = 152) {
    // Don't start new melody if one is already playing
    ...
    // Reset playing state when melody ends
    setTimeout(() => {
      isPlayingRef.current = false;
    }, totalDuration * 1000 + 1000); // Add extra buffer
  }
